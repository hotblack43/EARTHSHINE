...
# ---- Example Usage ----
fits_files = [
    "./OUTPUT/IDEAL/ideal_LunarImg_SCA_0p34577230_JD_2455864.7415237_illfrac_0.1608.fit",  # 1 layer
    "./OUTPUT/LONLAT_AND_ANGLES_IMAGES/lonlatSELimage_JD2455864.7415237.fits",  # 2 layers: Longitude & Latitude
    "./OUTPUT/LONLAT_AND_ANGLES_IMAGES/Angles_JD2455864.7415237.fits",  # 3 layers: Incidence, Emergence (Earth), Emergence (Observer)
    "./OUTPUT/SUNMASK/SunMask_JD_2455864.7415237.fit"  # 1 layer
]  
