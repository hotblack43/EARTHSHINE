...
PROFILER,/SYSTEM
 counter=0
 if (ifgraphicsflag eq 1) then window,0,xsize=400,ysize=400
...
observedimagename='/home/pth/SCIENCEPROJECTS/EARTHSHINE/fakefiltered_im.fit' ; this is with afake filter
modelimagename='/home/pth/SCIENCEPROJECTS/EARTHSHINE/flat.fit'
;----------------------------------------------------------------------------
;
...
; save for reference
 ...
 start_parms = [y0,x0,rotangle,scale,factor,NDfilter_OD]
 if (file_test(strcompress('/home/pth/SCIENCEPROJECTS/EARTHSHINE/'+str+'solution.dat',/remove_all)) eq 1) then begin
     openr,34,strcompress('/home/pth/SCIENCEPROJECTS/EARTHSHINE/'+str+'solution.dat',/remove_all)
 ...
 fixed:0, relstep:1e-3, limited:[0,0], limits:[0.D,0]}, 6)
parinfo[0].fixed = 1
parinfo[1].fixed = 1
parinfo[2].fixed = 1
parinfo[3].fixed = 1
...
print,'........................................'
 ; print,parinfo
 results = MPFIT2DFUN('calculate_SSE_ND', X, Y, Z, ERR, PARINFO=parinfo,perror=sigs,STATUS=hej)
