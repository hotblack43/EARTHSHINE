...
hiclip=0.99
lowclip=0.01
npeaks=9   ; Set number of peaks to fit
win=41          ; Set half-width of window to use - must use odd number
dw=win/2
radius=dw-3
;
set_plot,'ps
...
path='C:\Documents and Settings\Peter Thejll\Desktop\ASTRO\MOON\May27\obsrun1\'
image=readfits(path+'IMG254.FIT')
