@stuff19.pro
 ...
 contour,10^alogim,/isotropic,/cell_fill,xstyle=3,ystyle=3,color=fsc_color('white')
 return
 end
...
;..
 ...
 ;.....................................................................................
 ; Version 1: reads a set file given by a script
 ;.....................................................................................
 common paths,path
 common vizualise,viz,alogim
 common lineandpoint,line,point1
 ...
 line=[256,0,256,511]
 point1=[511,0]
 observed_image_name='special.fits'
 ...
 go_oplot_boxes,reform(x0+DSoffsetL),reform(x0+DSoffsetR),reform(y0+DSoffsetD),reform(y0+DSoffsetU)
 go_oplot_boxes,x0+BSoffsetL,x0+BSoffsetR,y0+BSoffsetD,y0+BSoffsetU
 ;print,x0+DSoffsetL,x0+DSoffsetR,y0+DSoffsetD,y0+DSoffsetU
 ;print,x0+BSoffsetL,x0+BSoffsetR,y0+BSoffsetD,y0+BSoffsetU
 ; extract DS
 DS=im_in(x0+DSoffsetL:x0+DSoffsetR,y0+DSoffsetD:y0+DSoffsetU)
 ; extract BS
 BS=im_in(x0+BSoffsetL:x0+BSoffsetR,y0+BSoffsetD:y0+BSoffsetU)
