...
for irow=285,315,10 do begin
openw,77,'symmetricstoplot.dat'
show=obs
 !P.MULTI=[0,2,1]
for icol=170,335,1 do begin
...
!P.MULTI=[0,1,3]
 ...
 !x.thick=2
 !y.thick=2
;plot,xstyle=3,ystyle=3,obsratio,ytitle='A/B observed, ideal (red)',psym=7
;oplot,idealratio,psym=7,color=fsc_color('red')
plot,xstyle=3,ystyle=3,yrange=[min([obsratio,idealratio]),max([obsratio,idealratio])],mean_eza,obsratio,xtitle='EZA',ytitle='A/B and A*/B*',psym=7
oplot,mean_eza,idealratio,psym=7,color=fsc_color('red')
plot,xstyle=3,ystyle=3,yrange=[min([obsratio,idealratio]),max([obsratio,idealratio])],mean_sza,obsratio,xtitle='SZA',ytitle='A/B and A*/B*',psym=7
