...
;    endif
 ...
 files=file_search(strcompress(inpath+'/'+JDwanted+'.*.fits',/remove_all),count=n)
 print,'Found ',n,' files to work on.'
 get_lun,wsy
 openw,wsy,'linear_scattered_light_remover_v13.log'
