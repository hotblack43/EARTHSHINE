...
;---------------------------------------------------------------------------------
; Reduces observations of stars - removes the mean of the two nearest dark frames
; from the smae night - i.e. the mean of the closest BEFORE the exposure and AFTER 
; Also sees to it that dark fields are not used if they have not cooled yet, and 
; that science frames are acceptably exposed
;---------------------------------------------------------------------------------
common ims,summdimages,counts,exptimes
exptimes=[4,8,16,32]
counts=exptimes*0
...
NIGHT='JD2455845/'
starname='ALTAIR'
path=strcompress('/data/pth/DATA/ANDOR/MOONDROPBOX/'+NIGHT,/REMOVE_ALL)
