...
;        endif
 ...
 ;
 fmt2='(i5,1x,i2,1x,i2,1x,f4.1,1x,i3,1x,i3,1x,i3,1x,f5.2,1x,f5.1,1x,f6.2,1x,i2,1x,i2,1x,i4,1x,i2,1x,i2,1x,i2,1x,f20.7)'
 ...
 ; generate list of sun and moon positions of rthe chosen interval
	...
	ramoon=ramoon/15.	; convert to decimal hours
     ...
     printf,66,format='(8(1x,f20.10),1x,f20.7)',RAmoon, DECmoon,a,b,c,d,e,f,double(jd)
     endfor	; loop jd
	close,66
 ...
 for istar=0,nstars-1,1 do begin
	...
	if (dec(istar) ge minDEC-1. and dec(istar) le maxDEC+1.) then begin
     ...
     if (airm le 2 and dis le 1000) then begin
         print,format='(6(1x,f9.1))',sixty(ra(istar)),sixty(dec(istar))
	 print,format='(6(1x,f9.1))',sixty(RAmoon),sixty(DECmoon)
         print,format=fmt2,istar,sixty(ra(istar)),sixty(dec(istar)),Vmag(istar),altmoon,azmoon,a,b,c,d,e,f,double(jd),dis
         printf,5,format=fmt2,istar,sixty(ra(istar)),sixty(dec(istar)),Vmag(istar),altmoon,azmoon,a,b,c,d,e,f,double(jd),dis
