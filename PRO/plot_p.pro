...
;===================================================
spawn," cat LRO.bootstrapperfitting_PSFisalfa1only.txt | awk '$7 != 2.0 && $7 != -2.0 && $8 !=2.0 && $8 !=-2.0 {print $2,$4}' > p"
pars=[]
data=get_data('p')
...
print,'---------------------------------------'
;----------------
spawn," cat LRO.bootstrapperfitting_PSFisalfa1only_fastercode.txt | awk '$7 != 2.0 && $7 != -2.0 && $8 !=2.0 && $8 !=-2.0 {print $2,$4}' > p"
data=get_data('p')                                                               
data(1,*)=data(1,*)*1.601890	; 1.601890 is the far-field halo-slope
...
print,'---------------------------------------'
;----------------
spawn," cat LRO.bootstrapperfitting_PSF_allpars_fastercode.txt | awk '$7 != 2.0 && $7 != -2.0  && $8 !=2.0 && $8 !=-2.0{print $2,$4}' > p"
data=get_data('p')                                                               
data(1,*)=data(1,*)*1.601890	; 1.601890 is the far-field halo-slope
