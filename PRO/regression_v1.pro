...
;.r MC_correlate_AR1
;
year1=1949	; the integer part of the FIRST year you want
year2=2005	; the year AFTER the last year you want
...
map_set,title='Standard deviation of layer mean T'
print,'Max,min of STD:',max(map_STD),min(map_STD)
levels=indgen(21)*0.1
colours=findgen(21)*255./21.
contour,map_STD,lon,lat,levels=levels,c_colors=colours,/cell_fill,/overplot
contour,map_STD,lon,lat,levels=levels,c_labels=indgen(n_elements(levels))*0+1,/overplot
map_continents,/overplot
end
