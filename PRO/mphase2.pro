...
;      and the phase angle in a coded way - to allow for the full lunar cycle, unlike mphase.pro
;
; CALLING SEQUENCE:
;       MPHASE2, jd, k
; INPUT:
...
; OUTPUT:
;       k - number describing the illumination:
;           0 - the New Moon
;           0-1 - the waxing Moon
;           1 - the full moon
;           1-2 - the wabing Moon
;           1.99999 - just before the next New Moon
; EXAMPLE:
...
;       IDL> mphase2, jd+dindgen(31), k        ;Moon phase for all 31 days
