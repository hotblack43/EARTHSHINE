...
PRO stack,files,stacked,dark,howmany,congridfactor
;--------------------------------------------------------------------------------
...
maxXshift=3
maxYshift=3
im0=double(readfits(files(imstart)))
l=size(im0,/dimensions)
...
files=file_search('DATA/','moon*.FIT')
;....................
; indicate the dark frame:
dark=float(readfits('DATA/sydneydark.fit'))
l=size(dark,/dimensions)
;....................
; set factor to rescale picture by (may be fraction)
congridfactor=1
dark=congrid(dark,l(0)*congridfactor,l(1)*congridfactor)
;....................
; perform the alignment and stacking:
howmany=349
stack,files,stacked,dark,howmany,congridfactor
;....................
