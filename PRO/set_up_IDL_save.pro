...
PRO get_data,file1,level,lon,lat,height,fracyear1,year1,year2
nlon=0L
nlat=0L
nlevels=0L
ntime=0L
...
height=height(*,idx,*,*)
;
idx=where(fracyear1 ge year1 and fracyear1 lt year2)
fracyear1=fracyear1(idx)
height=height(*,*,*,idx)
return
end
...
get_data,file1,level,lon,lat,height,fracyear1,1958,2002
...
get_data,file2,level,lon,lat,air,fracyear2,1958,2002
