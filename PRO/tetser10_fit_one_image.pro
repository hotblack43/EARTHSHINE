...
rebin_factor=1.0
probableradius=109.*rebin_factor	; does depend on pixel size...
probablex00=174.*rebin_factor
probabley00=260.*rebin_factor
maskleft=160*rebin_factor   ; column to start image rescaling at, from left
...
image=struct.im0
l=size(image,/dimensions)
if (rebin_factor ne 1) then image=congrid(image,l(0)*rebin_factor,l(1)*rebin_factor)
l=size(image,/dimensions)
...
image(maskleft:l(0)-1,*)=image(maskleft:l(0)-1,*)/9000.
