 PRO get_all_ideal_models,jd_in,image_stack,labels
 ...
 idx=where(strpos(files,'newH-63_LRO') ne -1)
 files=files(idx)
 n=n_elements(files)
 image_stack=[]
 labels=[]
...
print,'     alfa   bwpr  pedestal  albedo   xshift   corefac lamda0  yshifta     ZL       SL'
 ...
 ;........................................................................................
 close,/all
 ; Version 22 of code that finds albedo by model-fitting
 ; Uses a many-term polynomial PSF
 ; Uses flat fields designated by the filter name.
 ...
 while not eof(3) do begin
     ...
     if (illfrac lt 0.6) then begin
	     ...
	     ; first get ALL ideal images for this JD
             get_all_ideal_models,JD,image_stack,labels
