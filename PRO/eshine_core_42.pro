PRO get_LRO_map_anywavelength,lamda_wanted,new_map
 ...
 LRO=readfits('LRO/LRO_scaled.fits')
 ; Read in the trends found seperately, in each pixel
 LROtrends=readfits('LRO/lunar_albedo_trend.fits')
...
;              lunar albedo map - in the case of LRO aslo select the wavelength band
...
PRO eshine_core_42, JD, phase_angle, lat_lib, lon_lib, PA_lib,                 $
...
Print,"This is eshine_core_42.pro "
...
; Read the LRO map wavelength
get_lun,hgjfrte
openr,hgjfrte,'LAMDA0.txt'
LROlamda0=0.0d0
readf,hgjfrte,LROlamda0
close,hgjfrte
free_lun,hgjfrte
	print,'You have stated that your requested LRO wavelength is: ',LROlamda0
endif
...
if (if_want_LRO eq 1) then begin
	get_LRO_map_anywavelength,LROlamda0,PNORMMOON
endif
;......................................................
; PNORMMOON = float(X.field0001)
endif
...
;nameout3=strcompress('OUTPUT/IDEAL/idealimage_JD_'+string(JD,format='(f15.7)')+'.fits',/remove_all)
;writefits,nameout3,image_I,header55
;print,'Wrote file ',nameout3
END
