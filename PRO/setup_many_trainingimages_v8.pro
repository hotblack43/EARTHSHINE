 ...
 ; V8. Like V7, but makes more variants of each expensively generated image
 close,/all
 ...
 close,/all
 n=10	; make nxn boxes across the image
 ...
 spawn,"rm -f /data/OUTPUT/TABLE_TOTRAIN2.DAT"
 openw,22,'/data/OUTPUT/TABLE_TOTRAIN2.DAT'
 alfamin=1.4
 alfamax=3.0/1.61
 albedomin=0.2
 albedomax=0.5
...
;	 im=flipflopped
         gorotateimage,im
; writefits,strcompress('flipflop_'+string(iaction)+'.fits',/remove_all),im
;---reduce the image to blocks and writing the blocks to file ------
 ...
 data=get_data('/data/OUTPUT/TABLE_TOTRAIN2.DAT')
 print,'Description of data: '
 openw,22,'scaled_array.dat'
 printf,22,format='('+nsquaredstr+'(f12.6,","),f12.6)',data
 close,22
 print,'Huge table now at /data/OUTPUT/TABLE_TOTRAIN2.DAT ... '
