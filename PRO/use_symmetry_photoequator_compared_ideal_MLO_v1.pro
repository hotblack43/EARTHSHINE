...
; Version 1. runs along aline on the BS and finds mirror points on other side of PEq.
;---------------------------------------------------------------------------------
;
 !P.CHARSIZE=1.2
 !P.thick=3
 ...
 for irow=y0+10,y0+radius-10,10 do begin
     openw,77,'symmetricstoplot.dat'
     show=obs
     !P.MULTI=[0,2,1]
     for icol=x0,x0+radius,1 do begin
print,icol,irow
