...
mdx=where(xx gt mean(xx(kdx))-0.05 and xx lt mean(xx(kdx))+0.05)
res=poly_fit(xx(mdx),h(mdx),degree,yfit=yhat)
if (ifviz eq 1) then oplot,xx(mdx),yhat,color=fsc_color('red')
...
;print,'Starlight   :',SLcounts,' +/- ',sigs(9)
 ...
 ;........................................................................................
 ; Version 2 of code that finds the polynomial PSF by fitting to BS sky only
