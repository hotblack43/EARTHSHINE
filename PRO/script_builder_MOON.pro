...
; put in a factor of whim
expt=expt*0.615504*0.7*1.4	; seconds
...
;printf,44,'SHOOTSINGLES,'+string(expt,format='(f6.4)')+',1,512,512,MOON_'+fname+'_AIR,,,,'
...
; spawn,'cat separator.txt >> SCRIPT.out'
 ...
 print,' mv SCRIPT.out ~/INIandCSVfiles/MOONa.csv'
