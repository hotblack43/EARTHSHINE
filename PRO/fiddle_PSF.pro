...
PRO deconvolve,obs_in,ideal_in,PSF
...
!P.CHARSIZE=1.2
!P.CHARTHICK=2
deconvolve,obs,ideal,PSF1
writefits,'PSF_obs_ideal.fits',PSF1
deconvolve,obs,obs*mask,PSF2
...
deconvolve,obs,PSF1,deconvolved_obs
writefits,'obs_deconvolved_with_PSF1.fits',deconvolved_obs
deconvolve,obs,PSF1^2,deconvolved_obs
writefits,'obs_deconvolved_with_PSF1_squared.fits',deconvolved_obs
deconvolve,obs,PSF1^3,deconvolved_obs
writefits,'obs_deconvolved_with_PSF1_cubed.fits',deconvolved_obs
deconvolve,obs,PSF2,deconvolved_obs
...
; use Hanningw indow
deconvolve,obs*hanning(512,512),ideal*hanning(512,512),PSF1b
deconvolve,obs*hanning(512,512),obs*mask*hanning(512,512),PSF2b
