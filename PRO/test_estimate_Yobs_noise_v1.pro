PRO findcuspanglefromimage,im,x0,y0,radius,cangle
 ...
 for i=0,nims-1,1 do begin
     ...
     use_cusp_angle_fan_DS_BS,im,x0,y0,radius,rad,line,err_line,kmethod,w1,w2,w3,w4
...
;-------------------------------------------------------------------------------------
; Version 1. Code takes files listed in listtodo_fn.simex_trials and estimates
; the noise along the 'slice'
;-------------------------------------------------------------------------------------
 common stuff56,x0,y0,radius
 common cuspanglestuff,iflagcuspangle,cangle
 iflagcuspangle=1
 ...
 free_lun,y15
 im=reform(stack(*,*,2))
 findcuspanglefromimage,im,x0,y0,radius,cangle
 print,'Cangle=',cangle
