...
PRO eshine_21_particularsynthimage
...
;earth_BRDF   = 100
earth_albedo = -1.0
;f (earth_BRDF EQ 100 AND earth_albedo LE 0.0) then begin
; dummy=get_data('single_scattering_albedo.dat')
; single_scattering = dummy(0)
;ndif else if (earth_BRDF EQ 100) then begin
...
print,' So earth_albedo: ',earth_albedo
...
; camera_ID = 'sxvh9'
; camera_ID = 'STL1001E'
camera_ID = 'eshine_21_particularsynthimage'
exposure_time = 0.15
...
for iJD = JDstart,JDend,JDstep do begin
  ...
  ;writefits, strcompress('OUTPUT/LunarImg_'+string(iframe,format='(I4.4)')+'.fit',/remove_all), image_16bit, hedr
