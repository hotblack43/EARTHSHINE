PRO parsestr,str_in,hh,mm,ss,deg,mi,sec
 ...
 RAoffset=+0.0	; degrees
 DECoffset=-0.0	; degrees
 ...
 for ifilter=0,nfilters-1,1 do begin
     ...
     expt=expt*.52*(51./37.)*0.84*0.8*(54./48.)      ; seconds
     ...
     for i=0,N-1,1 do begin
         ...
         printf,44,'SHOOTKINETIC,'+string(expt,format='(f6.4)')+',100,512,512,MOON_DITHER_'+fname+'_AIR,,,,'
         printf,44,'SHOOTDARKFRAME,'+string(expt,format='(f6.4)')+',1,512,512,DARK,,,,'
