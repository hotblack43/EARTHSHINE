...
x1=135 &x2=158 & x3=230 &x4=255 &y1=187 & y2=211
get_photometric_ratio,x1,y1,x2,y2,x3,x4,difference,ratio3
...
PRO get_photometric_ratio,x1,y1,x2,y2,x3,x4,image,ratio
...
PRO get_observed_image,observed_image,observed_image_name
common moonres,im1,im2,im3
common ideal,cutoff
im1=readfits('earthshine_BBSO_crescent_coadded.fit')
x1=135 &x2=158 & x3=230 &x4=255 &y1=187 & y2=211
get_photometric_ratio,x1,y1,x2,y2,x3,x4,im1,ratio1
print,'In the ideal image the BS/ES ratio is     :',ratio1
printf,58,ratio1
observed_image=readfits(observed_image_name)
get_photometric_ratio,x1,y1,x2,y2,x3,x4,observed_image,ratio2
...
observed_image_name='fake_BBSO.fit'
get_observed_image,observed_image,observed_image_name
;----------------------------------------------------------
