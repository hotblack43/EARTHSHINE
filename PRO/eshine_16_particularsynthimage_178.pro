...
PRO eshine_16_particularsynthimage_178
...
print,'BEWARE: YOU ARE USING eshine_core_40, not _20 !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!'
  eshine_core_40, iJD, phase_angle, lat_lib, lon_lib, PA_lib, $
...
JDnumstr=string(JD,format="(f15.7)")
  ...
  caldat, iJD, mm, dd, yy, hh, mnt, sec
  convert_to_strings, mm, dd, yy, hh, mnt, sec, secstring, datestring, UTtimestring
  sxaddpar, header, 'ALBEDO', single_scattering, 'Single scattering albedo used on Earth model.'
  sxaddpar, header, 'DATE-OBS', datestring, 'Simulated date'
...
; write out image not scaled
  writefits,strcompress('OUTPUT/IDEAL/ideal_image_nodistvar_JD_'+string(IJD,format='(f15.7)')+'.fits' ,/remove_all), image_I*1.0d0, header
