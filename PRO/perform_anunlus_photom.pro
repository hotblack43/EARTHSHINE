...
PRO get_inner_circle,im,x0,y0,inner_radius,star_and_sky
 ...
 set_plot,'X
 r=dblarr(512,512)
 file='/media/LaCie/ASTRO/ANDOR/DoubleStar-WAnd/00000_*.fits'
 file='/data/pth/DATA/ANDOR/MOONDROPBOX/JD2455461/DoubleStar-WAnd/00000_*.fits'
 starname='WAnd'
 ...
 inner_radius=35.*1
     ...
     im=readfits(files(0),h)*ADU
     contour,im,/isotropic
 cursor,x0,y0
 for ii=0,n-1,1 do begin
     im=readfits(files(ii),h)*ADU
