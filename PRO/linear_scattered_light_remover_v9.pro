...
;    endif
 ...
 ;..............................................................................
 ; Version 9. BBSO method to remove the DS scattered light
 ; Works on real images
 ; Note that this code will write an output image even if there was no cleaning possible.
 ; Handle this by later inspecting x0,y0,radius in the header.
 ; Unlike version 8, assumes that all files will be found in DARKCURRENTREDUCED/
 ;..............................................................................
 common paths,path
 common circleSTUFF,circle,radius,moon_coords
 common rememberthis,firstguess
 ...
 common lineandpoint,line,point1
 common which,whichcleaned
 basepath=strcompress('/data/pth/DARKCURRENTREDUCED/',/remove_all)
 inpath=basepath
 ...
 line=[256,0,256,511]
 point1=[511,0]
 files=file_search(strcompress(inpath+'245*.fits',/remove_all),count=n)
 print,'Found ',n,' files to work on.'
 get_lun,wsy
 openw,wsy,'linear_scattered_light_remover_v9.log'
 fmt='(6(1x,f9.3),f8.1,1x,e11.5,1x,i3,1x,a)'
 for i=0,n-1,1 do begin
	 ...
	 q_flag=0
         get_observed_image,observed_image_name,observed_image,header,cg_x,cg_y,q_flag
	 ...
	 ; add info to header
	 radius=radius(0)
         sxaddpar, header, 'DISCX0', x0, 'Estimated centre column coordinate'
         sxaddpar, header, 'DISCY0', y0, 'Estimated centre row coordinate'
         sxaddpar, header, 'DISCRA', radius, 'Estimated disc radius'
         ...
         t2=systime(/julian)
         printf,wsy,format=fmt,firstguess,x0,y0,radius,maxflux,totflux,q_flag,files(i)
         endfor
     endfor
 close,wsy
 free_lun,wsy
