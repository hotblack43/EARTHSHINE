...
;
;-----------------------------------------------------------------------
moon_BRDF    = 401	; use Hapke-X (see above)
moon_BRDF    = 301	; use Hapke-63 (see above)
moon_albedo  = -1.0
moon_mix     = -1.0
...
earth_BRDF   = 100
earth_albedo = -1.0
if (earth_BRDF EQ 100 AND earth_albedo LE 0.0) then begin
  print,'Single-scattering albedo is set to: ', 0.3
  single_scattering = 0.3
endif else if (earth_BRDF EQ 100) then begin
  print,'Single-scattering albedo is set to: ', earth_albedo
  single_scattering = earth_albedo
endif
