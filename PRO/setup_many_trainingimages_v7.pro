...
; and takes the log10 to compress values
 ...
 ; V7. Like V6, but applies a +/- 180 degree roattion to the 
 ; image instead of the 0, 90, 180, 270 stuff in v6
...
;im1=shift(im1,40,-50)
 ...
 spawn,"rm -f /data/OUTPUT/TABLE_TOTRAIN.DAT"
 ...
 for ims=0L,nims-1,1 do begin
     ...
     gorotateimage,iim
 ;   goshiftimage,iim,n
;---------------reducing the image to blocks and writing the blocks to file ------------------
; write image as is
