...
;
;....
	parinfo=replicate({mpside:2,value:0.D,fixed:0,limited:[0,0],limits:[0.D,0],step:0.0},5)
...
; setting limits on aerosol power
	...
	parinfo(3).limits[0]=-2.0d0
	parinfo(3).limits[1]=-1.
	parinfo(3).fixed=1
; setting limits on O3 factor
	parinfo(4).limited[0]=1
	parinfo(4).limits[0]=0.0d0	; should be positive
	parinfo(4).fixed=0
; set start values
	a(0)=0.008
	a(1)=-4.4
...
; Now select those solutions that did not "go to the rail"
; call something here ...
!P.MULTI=[0,1,5]
