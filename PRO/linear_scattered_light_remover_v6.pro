...
;fitsname=strmid(str,xx,strlen(str)-xx)
 ...
 PRO remove_scattered_light_linear_method,observed_image,clean_image,inside,outside,DSonleft
...
;............................
 ...
 for theta=0.0d0,180.0d0-theta_step,theta_step do begin
     ...
     close,44
     go_fit_line,'bins.dat',res
     go_clean_lunar_disc,res,theta,theta_step,clean_image,radii,angle,removed_light,whichcleaned
     endfor	; end theta
...
;............................
 ...
 ; Version 6: Like version 5 - except that data inside cones are fit as is - i.e. not
 ...
 for i=0,n-1,1 do begin
	...
	print,'DSonleft: ',DSonleft
     remove_scattered_light_linear_method,observed_image,cleaned_image,inside,outside,DSonleft
     ;
     writefits,strcompress(outpath+fitsname,/remove_all),cleaned_image,header
