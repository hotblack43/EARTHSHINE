...
rnd=randomu(seed,poisson=n*im(i,j)+1)/float(n)
im(i,j)=rnd
endfor
endfor
return
...
print,'     alfa   bwpr  pedestal  albedo   xshift   corefac lamda0  yshifta     ZL       SL'
 ...
 ;..............................................................................
 ; Version 1 of code that fits ideal convolved images to images generated 
...
close,91
         ...
         if (x0-radius gt 31 and rawncols-1-(x0+radius) gt 31 ) then begin
             ...
             openw,63,'CLEM.ideal_alfa_and_dx_and_dy_clementine_NO_Poisson_noisefrom100ims_0.31albedo_Jan_19_2017.txt',/append
             flux=totfl/exptime
