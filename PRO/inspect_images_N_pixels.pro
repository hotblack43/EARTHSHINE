PRO extract_photometry,im,N,x1,y1,x2,y2,phot1,phot2
 ...
 x2=368
 y2=276
 files=file_search('align_stacked_CoAdd*.fits',count=nims)
 ...
 for N=0,9,1 do begin	; this is the 'half width of the window around the central pixel
     ...
     fmt='(a,i3,1x,f15.6,1x,f8.4,1x,f9.6,1x,f12.6,1x,f14.8,1x,i2)'
     fmt2='(i3,1x,f15.6,1x,f8.4,1x,f9.6,1x,f12.6,1x,f14.8,1x,i2)'
     labs='#, JD, EXP, phot1,phot2,ph1/ph2,N = '
     print,format=fmt,labs,0,time,exptime,phot1,phot2,phot1/phot2,N
     printf,5,format=fmt2,0,time,exptime,phot1,phot2,phot1/phot2,N
     for i=1,nims-1,1 do begin
         ...
         print,format=fmt,labs,i,time,exptime,phot1,phot2,phot1/phot2,N
         printf,5,format=fmt2,i,time,exptime,phot1,phot2,phot1/phot2,N
