...
PRO go_contrast_im2,im2,im2contrasted,contrast
 ...
 ;goaddZodiacaltoModelImage,zodi,mixedimage
 ; fold 
...
;------------------------------------------
 ...
 yshift=0.0;47131281
 zodi=0.006587441
 p = [alfa1,rlimit,pedestal,albedo,xshift,corefactor,contrast,yshift,zodi]
 ...
 fixed:0, limited:[0,0], limits:[0.D,0],step:1d-4}, 9)
 parinfo[0].fixed = 0
 parinfo[1].fixed = 1
 parinfo[2].fixed = 0
 parinfo[3].fixed = 0
