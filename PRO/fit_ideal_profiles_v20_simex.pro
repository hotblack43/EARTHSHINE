PRO gosavethexandyandparameters,simexlambda
common simex,observed,modelled
plot,modelled,observed,xtitle='Model',ytitle='Observed',psym=7,title='!7k!3 = '+string(simexlambda,format='(f7.3)')
res=robust_linefit(modelled,observed)
xx=findgen(100)/99.*(max(modelled)-min(modelled))+min(modelled)
yhat=res(0)+res(1)*xx
oplot,xx,yhat,color=fsc_color('red')
printf,77,simexlambda,res(1)
end
...
print,'     alfa   bwpr  pedestal  albedo   xshift   corefac lamda0  yshifta     ZL       SL'
 ...
 ;........................................................................................
 ; Version 20 of code that finds albedo by model-fitting
...
close,91
         ...
         if (x0-radius gt 31 and rawncols-1-(x0+radius) gt 31 ) then begin
             ...
             gosavethexandyandparameters,simexlamda
             print,'RMSE: ',RMSE
             ...
             openw,63,'CLEM.testing_FEB_19_2015.txt',/append
             flux=totfl/exptime
             printf,63,format=fmtstr44,JD,albedo,erralbedo,alfa1,bwpr,pedestal,xshift,yshift,acoeff,lamda0,RMSE,totfl,zodi,SLcounts,flux,name,labelstr,filter
             close,63
