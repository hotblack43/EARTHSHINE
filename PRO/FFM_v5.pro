...
; set up the ideal image wighted by albedo
 ...
 ;----------------------------------------------------
 ; version 5 of Full Forward Method
 ; will loop over images
 ; Like version 4 but loops over a range of models
 ;----------------------------------------------------
 !P.CHARSIZE=2
 common ims,observed,trialim,idealused,ideal,blackimage,whiteimage
 common errs,functionvalue,residual2BOX
 openw,82,'allresults_FFM_v5.txt'
 files=file_search('/data/pth/RESULTS/INPUT/IDEAL/SCA_0p297/Lu*',count=nfiles)
 ...
 blackimage=readfits('/data/pth/RESULTS/INPUT/IDEAL/SCA_0p000/'+filename)
 whiteimage=readfits('/data/pth/RESULTS/INPUT/IDEAL/SCA_1p000/'+filename)
 ; define some real-world effects
 factor=3.78
 pedestal=400.0
 ; generate a synthetic observed image
 spawn,'cp /data/pth/RESULTS/INPUT/IDEAL/SCA_0p297/'+filename+' ideal_in.fits'
 ...
 ;pawn,'./syntheticmoon usethisidealimage.fits synth_observed_1p7.fits 1.7 100'
 spawn,'./syntheticmoon usethisidealimage.fits synth_observed_1p8.fits 1.8 1'
 ;spawn,'./syntheticmoon usethisidealimage.fits synth_observed_1p6.fits 1.6 100'
 ;spawn,'./syntheticmoon usethisidealimage.fits synth_observed_1p7.fits 1.7 100'
 ;spawn,'./syntheticmoon usethisidealimage.fits synth_observed_1p8.fits 1.8 100'
