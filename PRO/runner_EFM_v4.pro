...
common xys,x,y,iflagxys
if (iflagxys ne 314) then begin
...
print,'Calculated and stored x and y'
iflagxys=314
endif
;----------------------------------------
...
if ((i lt 11 or i gt 500) and (j lt 11 or j gt 500)) then begin
...
iflagxys=1
 ...
 outpath=strcompress('EFMCLEANED_2/',/remove_all)
 str=strcompress(lowpath+'DARKCURRENTREDUCED/DISKESTIAMTEDANDROTATED/*.fits',/remove_all)
