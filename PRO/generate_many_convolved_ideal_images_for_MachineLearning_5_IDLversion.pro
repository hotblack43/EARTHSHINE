...
free_lun,hjkl
;================================================
spawn,'idl go_get_particular_synthimage_16_for_ML.pro'
get_lun,iuhgyuygf
...
; generate Poisson noise - should it be 'added'? Isn't it a 'draw from' situation?.
	...
	writefits,strcompress('/home/hotblack43/WORKSHOP/EARTHSHINE_CODE/OUTPUT/MLIMAGES_100SUMMED/testim_'+string(albedo)+'_'+string(illfrac)+'_.fits',/remove_all),folded
	endif
endfor
end
