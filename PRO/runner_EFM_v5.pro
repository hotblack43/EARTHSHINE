...
return
 ...
 lowpath='/data/pth/'
 outpath=strcompress('EFMCLEANED_0p7MASKED/',/remove_all)
; path to input files
 str=strcompress(lowpath+'DARKCURRENTREDUCED/SELECTED_1/*.fits',/remove_all)
; /data/pth/DARKCURRENTREDUCED/SELECTED_1/
 ...
 get_mask,maskFLIPneeded,x0,y0,radius+6,mask
