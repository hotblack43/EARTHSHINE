...
;p(6)=1.0	; B lamda0
 ...
 parinfo[*].value = p
 ;
 w1=40	; inside edge on DS sky
 w2=150	; outside disc edge on DS disc
 w3=70	; beyond edge on BS sky
...
print,'     alfa   rlimit  pedestal  albedo   xshift   corefac lamda0  yshifta     ZL       SL'
 ...
 ;........................................................................................
 ; Version 17 of code that finds albedo by model-fitting
 ; Like version 15 but is meant for trails on rlimit
 ;........................................................................................
 common stuff117,name,use1,use2,im1,im2,raw,RMSE,x0,y0,radius,nbands,w1,w2,w3,w4
 common namingstuff,JD,labelstr,markedupimage,if_smoo,if_jiggle,jiggle_ampl
 common fanstuff,rad_raw,line_raw,rad_folded,line_folded
...
close,91
         ...
         if (x0-radius gt 31 and rawncols-1-(x0+radius) gt 31 ) then begin
             ...
             openw,63,'CLEM.testing_JAN_21_2015.txt',/append
             flux=totfl/exptime
             printf,63,format=fmtstr44,JD,albedo,erralbedo,alfa1,rlimit,pedestal,xshift,yshift,corefactor,lamda0,RMSE,totfl,zodi,SLcounts,flux,name,labelstr,filter
             close,63
