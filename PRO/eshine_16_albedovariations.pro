...
PRO eshine_16_albedovariations
...
get_lun,chj
openr,chj,'Iearth.now'
readf,chj,Iearth
close,chj & free_lun,chj
  sxaddpar, header, 'Iearth', Iearth, 'Earthshine intensity'
...
JDnumstr=string(JD,format="(f20.6)")
  writefits, strcompress('OUTPUT/IDEAL/ideal_LunarImg_SCA_'+SCAnumstr+'_JD_'+JDnumstr+'.fit',/remove_all), image_I, header
...
close,chj & free_lun,chj
  ...
  writefits, strcompress('OUTPUT/MAPofEARTH_'+string(iframe,format='(I4.4)')+'.fits',/remove_all), MAPofEARTH
