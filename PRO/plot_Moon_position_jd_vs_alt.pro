...
step=.1/24.
;plot,[0,1,2],[2,3,4],/nodata,xrange=[0,360],yrange=[0,90]
plot,[0,1,2],[2,3,4],/nodata,xrange=[0,stop-start],yrange=[0,60],xtitle='Days since start',title='Start:'+'Oct 10 2006'
...
;
;if (sun_alt lt -15 and(k gt 0.2 and k lt 0.8) and (airmass lt 4)) then oplot,[jd-start,jd-start],[moon_alt,moon_alt],psym=8,symsize=k*0.5
