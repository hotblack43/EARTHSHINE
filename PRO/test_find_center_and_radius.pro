...
PRO find_center_and_radius,im_in,x00,y00,radius,x0,y0,r
common facts,probableradius,probablex00,probabley00
image=im_in

fit_moon1,image,x00,y00,radius,x0,y0,r	; will find center coords and radius
return
end
...
PRO guess_shifts,im_in,reference_im,x00,y00
get_FFT_shift,im_in,reference_im,x00,y00
return
end
...
reference_im=readfits(files(0),header)
l=size(reference_im,/dimensions)
reference_im=shift(reference_im,176.23,259.87)
openw,23,'FittedAndrewcoords.dat'
for i=0,0,1 do begin
	...
	guess_shifts,im_in,reference_im,x00,y00
	print,'Guess:',x00,y00
    workimage=double(im_in)-double(dark)
	find_center_and_radius,workimage,x00,y00,radius00,x0,y0,r
	print,format='(3(1x,f9.2),1x,f20.5,1x,f8.4)',x0,y0,r,JD,exptime
	printf,23,format='(3(1x,f9.2),1x,f20.5,1x,f8.4)',x0,y0,r,JD,exptime
endfor
close,23
end
