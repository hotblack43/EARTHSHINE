...
return
 ...
 common displays,if_display
 ; set the Model type
 modeltype=2	; User can set 1 or two here - model is shown further down
 if_display=0	; leave at 0
 !P.CHARSIZE=2
 get_lun,w
 ...
 for ifile=1,32,1 do begin
     ...
     if (SALexist*TRSexist*TISexist*CFCexist eq 1) then begin
         ...
         scatter_col,yhat,albedo(idx),minx=0.,miny=0.,maxx=1.0,maxy=1.0,binx=0.01,biny=0.01, 	$
