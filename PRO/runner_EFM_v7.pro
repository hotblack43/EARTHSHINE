...
return
 ...
 ;--------------------------------------------------------------------
 ; RUNNER version 7. EFM method.
 ; Like version 6, but has option for 'anchoring' the halo on the DS sky, 
 ; But a factor for the sacling - i.e. no flux conservation.
 ;--------------------------------------------------------------------
 !P.CHARSIZE=2
 common ims,observed,source,residual,mask,trialim,cleanup
 common errs,errorwholeimage,errorinabox,idealerrorinabox,b,idealbiasinbox
...
; path to input files
 str=strcompress(lowpath+'DARKCURRENTREDUCED/SELECTED_2/24*.fits',/remove_all)
 ...
 print,'From header: x0,y0: ',x0,y0,' radius: ',radius
     ...
     PSFfactor=1.0d0
print,'Starting guess a,alfa,PSF factor=',a,alfa,PSFfactor
 ...
 if (x0 gt radius+40 and x0 lt 511-radius-40 and y0 gt radius+40and y0 lt 511-radius-40) then begin
 get_time,header,JD
