...
; - Run mode
;
; Version 278 - special version of eshine_16 that reads some input from files
...
PRO eshine_16_particularsynthimage_278
...
get_lun,opopop
openw,opopop,'what_BRDF_albedo_switches.used'
printf,opopop,hapkeG,hapket,moon_albedo,moon_BRDF,earth_albedo,earth_BRDF
close,opopop
