...
print,'     alfa   bwpr  pedestal  albedo   xshift   corefac lamda0  yshifta     ZL       SL'
 ...
 PRO goseeksuccess,res,yesondiskflag,file0,file1
 if (n_elements(res) ne 2) then return
 idx=strpos(res,'0p0')
 jdx=strpos(res,'1p0')
 file0pointer=where(idx ne -1)
 file1pointer=where(jdx ne -1)
 file0=res(file0pointer)
 file1=res(file1pointer)
 print,file0,file1
 yesondiskflag=1
 return
 end
...
;writefits,'im2_justaftercreation.fits',im2
 ...
 ;..............................................................................
 ; Version 31 of code that finds albedo by model-fitting
 ; Special code set up to enable later fitting of ideal images.
 ; Vstop 31 does not generate ideal images - it reads them, if they already exist, from disk
 ;..............................................................................
 common stuff117,name,use1,use2,im1,im2,raw,RMSE,x0,y0,radius,nbands,w1,w2,w3,w4
 common namingstuff,JD,labelstr,markedupimage,if_smoo,if_jiggle,jiggle_ampl,paramname
 common fanstuff,rad_raw,line_raw,rad_folded,line_folded
...
; name of the PSF parameters
 ...
 spawn,"rm mixed117.fits im2.fits im1.fits im2_justaftercreation.fits ItellYOUwantTHISimage.fits im1_justaftercreation.fits trialout117.fits";,/NOSHELL
 close,/all
...
;            get_two_synthetic_images,JD,im1_good,im2_good,mixedimageheader,if_want_LRO
             get_two_synthetic_images_usedisk,JD,im1_good,im2_good,mixedimageheader,if_want_LRO
             labelstr=' '+'LRO_scaled'
             im1=im1_good
             im2=im2_good
             ;..........................................
             ...
             openw,63,'CLEM.bootstrapperfitting_faster.txt',/append
             flux=totfl/exptime
