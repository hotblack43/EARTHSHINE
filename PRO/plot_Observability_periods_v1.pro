...
salt=reform(data(1,*))
malt=reform(data(2,*))
plot,xJD-2455550.0d0,salt,psym=7,thick=3,xtitle='Days since 2455550.0d0',yrange=[min([salt,malt]),max([salt,malt])],xrange=[mean(xJD-2455550.0d0)-0.5,mean(xJD-2455550.0d0)+0.5],ytitle='Altitude of Sun and Moon',title='Duration = '+string(24.*(max(xJD)-min(xJD)))+' hrs.'
