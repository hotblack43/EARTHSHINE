...
; make the super flat field
files=file_search('OUTPUT/','flat_*.fit',count=n)
for i=0,min([n-1,50]),1 do begin
	print,i,'  ',files(i)
...
for i=0,n-1,1 do begin
	...
	writefits,strcompress('OUTPUT/UNflatdarked_'+files(i),/remove_all),float((im-dark)/flat),header
endfor
end
