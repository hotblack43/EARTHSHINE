...
print, JD, lat_lib, lon_lib, PAaxis_lib
stop
...
print, Dse, Dem, phase_angle_E, phase_angle_M
...
if (if_variable_distances eq 1) then begin
hangle, JD, RAmoon*!dtor, DECmoon*!dtor, observatory_latitude*!dtor, observatory_longitude*!dtor, HAm, lst
HAm = 15.0d*HAm
; INPUTS:
...
Xobs = Dem - Rearth*cos(HAm*!dtor)*cos(DECmoon*!dtor)
Yobs = Rearth*sin(HAm*!dtor)
Zobs = Rearth*cos(HAm*!dtor)*sin(DECmoon*!dtor)
endif
...
moon_albedo  = 0     ; 0=uniform (0.0720) , 1=Clementine albedos from file
...
mm  = 1            ; Observing month
dd  = 1           ; Observing day of that month
yy  = 2006         ; Observing year
hh  = 0           ; Observing hour UT
mnt = 0            ; Observing minute past that hour
...
; jdstart = JD+223
; jdstep =  1.0/24.
; for JD=jdstart,jdstart+7.0,jdstep do begin
