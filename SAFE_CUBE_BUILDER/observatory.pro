...
;+
;-------------------------------------------------
; Note inserted by PTH: Make sure you undersatnd the 
; sign convention on longitude here! It can create
; confusion when you later use 'eq2hor' where thge sign convention
; is the opposite of here.
; See notes in eq2hor.pro
;-------------------------------------------------
; NAME:
;       OBSERVATORY
; PURPOSE:
...
;  'mlo': Canada-France-Hawaii Telescope
...
obs=[ 'thule','lund','mlo','tug', 'dmi', 'kpno','ctio','eso','lick','mmto','cfht','lapalma','mso','sso','aao', $
...
; REMEMBER that all longitudes have to be degrees WEST - not the usual EAST!!!!
"thule": begin
